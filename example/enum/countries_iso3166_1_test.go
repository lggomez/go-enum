...
func TestCountriesIso31661_UnmarshalJSON(t *testing.T) {
	t.Run("Unmarshal_InvalidValue", func(t *testing.T) {
		data := `{"countries_iso3166_1":"invalid_bc3b8624-a00a-4336-9d48-35aaff75b3dc"}`
		rawData := []byte(data)
...
func TestCountriesIso31661_TextCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalText([]byte("invalid_bc3b8624-a00a-4336-9d48-35aaff75b3dc"))
		require.NotNil(t, err)
	})
}
...
func TestCountriesIso31661_BinaryCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalBinary([]byte("invalid_bc3b8624-a00a-4336-9d48-35aaff75b3dc"))
		require.NotNil(t, err)
	})
}
...
func TestCountriesIso31661_GobCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.GobDecode([]byte("invalid_bc3b8624-a00a-4336-9d48-35aaff75b3dc"))
		require.NotNil(t, err)
	})
}
