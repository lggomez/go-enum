...
func TestCountriesIso31661_UnmarshalJSON(t *testing.T) {
	t.Run("Unmarshal_InvalidValue", func(t *testing.T) {
		data := `{"countries_iso3166_1":"invalid_ed64210b-0d46-4daa-a747-dc463a7256e8"}`
		rawData := []byte(data)
...
func TestCountriesIso31661_TextCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalText([]byte("invalid_ed64210b-0d46-4daa-a747-dc463a7256e8"))
		require.NotNil(t, err)
	})
}
...
func TestCountriesIso31661_BinaryCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalBinary([]byte("invalid_ed64210b-0d46-4daa-a747-dc463a7256e8"))
		require.NotNil(t, err)
	})
}
...
func TestCountriesIso31661_GobCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.GobDecode([]byte("invalid_ed64210b-0d46-4daa-a747-dc463a7256e8"))
		require.NotNil(t, err)
	})
}
