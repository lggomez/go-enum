...
func TestEnumValue_UnmarshalJSON(t *testing.T) {
	...
	t.Run("Unmarshal_InvalidValue", func(t *testing.T) {
		data := `{"enum_value":"invalid_8e0f038a-3281-401b-b750-4614942902b5"}`
		rawData := []byte(data)
...
func TestEnumValue_TextCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.UnmarshalText([]byte("invalid_8e0f038a-3281-401b-b750-4614942902b5"))
		require.NotNil(t, err)
	})
}
...
func TestEnumValue_BinaryCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.UnmarshalBinary([]byte("invalid_8e0f038a-3281-401b-b750-4614942902b5"))
		require.NotNil(t, err)
	})
}
...
func TestEnumValue_GobCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		err := c.GobDecode(nil)
		require.NoError(t, err)
		err = c.GobDecode([]byte("invalid_8e0f038a-3281-401b-b750-4614942902b5"))
		require.NotNil(t, err)
	})
}
