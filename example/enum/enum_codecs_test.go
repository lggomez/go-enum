...
func TestEnumValue_UnmarshalJSON(t *testing.T) {
	...
	t.Run("Unmarshal_InvalidValue", func(t *testing.T) {
		data := `{"enum_value":"f7691f39-0d7f-4fd9-8a44-757ed1662a35"}`
		rawData := []byte(data)
...
func TestEnumValue_TextCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.UnmarshalText([]byte("f7691f39-0d7f-4fd9-8a44-757ed1662a35"))
		require.NotNil(t, err)
	})
}
...
func TestEnumValue_BinaryCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.UnmarshalBinary([]byte("f7691f39-0d7f-4fd9-8a44-757ed1662a35"))
		require.NotNil(t, err)
	})
}
...
func TestEnumValue_GobCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		err := c.GobDecode(nil)
		require.NoError(t, err)
		err = c.GobDecode([]byte("f7691f39-0d7f-4fd9-8a44-757ed1662a35"))
		require.NotNil(t, err)
	})
}
