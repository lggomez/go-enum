...
func TestEnumValue_UnmarshalJSON(t *testing.T) {
	...
	t.Run("Unmarshal_InvalidValue", func(t *testing.T) {
		data := `{"enum_value":"e259662b-1560-45a9-bed4-5ae2c4fdfe3d"}`
		rawData := []byte(data)
...
func TestEnumValue_TextCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.UnmarshalText([]byte("e259662b-1560-45a9-bed4-5ae2c4fdfe3d"))
		require.NotNil(t, err)
	})
}
...
func TestEnumValue_BinaryCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.UnmarshalBinary([]byte("e259662b-1560-45a9-bed4-5ae2c4fdfe3d"))
		require.NotNil(t, err)
	})
}
...
func TestEnumValue_GobCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		err := c.GobDecode(nil)
		require.NoError(t, err)
		err = c.GobDecode([]byte("e259662b-1560-45a9-bed4-5ae2c4fdfe3d"))
		require.NotNil(t, err)
	})
}
