...
func TestEnumValue_UnmarshalJSON(t *testing.T) {
	...
	t.Run("Unmarshal_InvalidValue", func(t *testing.T) {
		data := `{"enum_value":"invalid_ed64210b-0d46-4daa-a747-dc463a7256e8"}`
		rawData := []byte(data)
...
func TestEnumValue_TextCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.UnmarshalText([]byte("invalid_ed64210b-0d46-4daa-a747-dc463a7256e8"))
		require.NotNil(t, err)
	})
}
...
func TestEnumValue_BinaryCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.UnmarshalBinary([]byte("invalid_ed64210b-0d46-4daa-a747-dc463a7256e8"))
		require.NotNil(t, err)
	})
}
...
func TestEnumValue_GobCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		err := c.GobDecode(nil)
		require.NoError(t, err)
		err = c.GobDecode([]byte("invalid_ed64210b-0d46-4daa-a747-dc463a7256e8"))
		require.NotNil(t, err)
	})
}
