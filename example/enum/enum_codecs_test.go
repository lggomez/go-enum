...
func TestEnumValue_UnmarshalJSON(t *testing.T) {
	...
	t.Run("Unmarshal_InvalidValue", func(t *testing.T) {
		data := `{"enum_value":"a4d526d1-9045-444b-9802-311a78e9385d"}`
		rawData := []byte(data)
...
func TestEnumValue_TextCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.UnmarshalText([]byte("a4d526d1-9045-444b-9802-311a78e9385d"))
		require.NotNil(t, err)
	})
}
...
func TestEnumValue_BinaryCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.UnmarshalBinary([]byte("a4d526d1-9045-444b-9802-311a78e9385d"))
		require.NotNil(t, err)
	})
}
...
func TestEnumValue_GobCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		err := c.GobDecode(nil)
		require.NoError(t, err)
		err = c.GobDecode([]byte("a4d526d1-9045-444b-9802-311a78e9385d"))
		require.NotNil(t, err)
	})
}
