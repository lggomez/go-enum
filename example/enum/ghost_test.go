...
func TestGhost_MarshalJSON(t *testing.T) {
	...
	t.Run("Marshal_StructFieldPtr", func(t *testing.T) {
		dt := enum.GhostBlinky
		val := dt()
		vPtr := fooGhostPtr{TestValue: &val}
		data, err := json.Marshal(vPtr)
		require.Nil(t, err)
...
func TestGhost_UnmarshalJSON(t *testing.T) {
	t.Run("Unmarshal_InvalidValue", func(t *testing.T) {
		data := `{"ghost":"invalid_86e96fc2-69ac-471a-92b4-c8fb91fd761c"}`
		rawData := []byte(data)
...
func TestGhost_TextCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalText([]byte("invalid_86e96fc2-69ac-471a-92b4-c8fb91fd761c"))
		require.NotNil(t, err)
	})
}
...
func TestGhost_BinaryCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalBinary([]byte("invalid_86e96fc2-69ac-471a-92b4-c8fb91fd761c"))
		require.NotNil(t, err)
	})
}
...
func TestGhost_GobCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.GobDecode([]byte("invalid_86e96fc2-69ac-471a-92b4-c8fb91fd761c"))
		require.NotNil(t, err)
	})
}
