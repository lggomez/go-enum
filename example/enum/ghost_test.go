...
func TestGhost_UnmarshalJSON(t *testing.T) {
	t.Run("Unmarshal_InvalidValue", func(t *testing.T) {
		data := `{"ghost":"invalid_a9f3e9c6-d270-46fb-ad29-46dcb80341c9"}`
		rawData := []byte(data)
...
func TestGhost_TextCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalText([]byte("invalid_a9f3e9c6-d270-46fb-ad29-46dcb80341c9"))
		require.NotNil(t, err)
	})
}
...
func TestGhost_BinaryCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalBinary([]byte("invalid_a9f3e9c6-d270-46fb-ad29-46dcb80341c9"))
		require.NotNil(t, err)
	})
}
...
func TestGhost_GobCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.GobDecode([]byte("invalid_a9f3e9c6-d270-46fb-ad29-46dcb80341c9"))
		require.NotNil(t, err)
	})
}
