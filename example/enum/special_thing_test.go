...
func TestSpecialThing_UnmarshalJSON(t *testing.T) {
	t.Run("Unmarshal_InvalidValue", func(t *testing.T) {
		data := `{"special_thing":"invalid_e9ab399c-15c8-4ae1-9c60-7dfe882c2a94"}`
		rawData := []byte(data)
...
func TestSpecialThing_TextCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalText([]byte("invalid_e9ab399c-15c8-4ae1-9c60-7dfe882c2a94"))
		require.NotNil(t, err)
	})
}
...
func TestSpecialThing_BinaryCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalBinary([]byte("invalid_e9ab399c-15c8-4ae1-9c60-7dfe882c2a94"))
		require.NotNil(t, err)
	})
}
...
func TestSpecialThing_GobCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.GobDecode([]byte("invalid_e9ab399c-15c8-4ae1-9c60-7dfe882c2a94"))
		require.NotNil(t, err)
	})
}
