...
func TestSpecialThing_UnmarshalJSON(t *testing.T) {
	t.Run("Unmarshal_InvalidValue", func(t *testing.T) {
		data := `{"special_thing":"invalid_b335ee2d-de25-4dca-8623-b21e004a535b"}`
		rawData := []byte(data)
...
func TestSpecialThing_TextCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalText([]byte("invalid_b335ee2d-de25-4dca-8623-b21e004a535b"))
		require.NotNil(t, err)
	})
}
...
func TestSpecialThing_BinaryCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.UnmarshalBinary([]byte("invalid_b335ee2d-de25-4dca-8623-b21e004a535b"))
		require.NotNil(t, err)
	})
}
...
func TestSpecialThing_GobCodec(t *testing.T) {
	...
	t.Run("UnmarshalText_Invalid", func(t *testing.T) {
		...
		require.NoError(t, err)
		err = c.TestValue.GobDecode([]byte("invalid_b335ee2d-de25-4dca-8623-b21e004a535b"))
		require.NotNil(t, err)
	})
}
